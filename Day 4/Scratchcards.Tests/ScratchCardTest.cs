...
public class ScratchCardTest
{
    ...
    public void ScratchCard_Should_Return_Correct_Points(string cardValue, int expectedPoints)
    {
        // Arrange

        var scratchCard = new ScratchCard(cardValue);

        // Act

        var points = scratchCard.Points;
